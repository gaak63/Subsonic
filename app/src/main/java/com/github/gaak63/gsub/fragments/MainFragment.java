...
import com.github.gaak63.gsub.adapter.MainAdapter;
	...
	private void showAboutDialog() {
		new LoadingTask<Void>(context) {
			...
			protected void done(Void result) {
				...
				details.add("com.github.gaak63.gsub.android@gmail.com");
		...
		try {
			...
			new LoadingTask<String>(context) {
				...
				protected String doInBackground() throws Throwable {
					...
					File logcat = new File(Environment.getExternalStorageDirectory(), "com.github.gaak63.gsub-logcat.txt");
					Util.delete(logcat);
					...
					try {
						...
						File stacktrace = new File(Environment.getExternalStorageDirectory(), "com.github.gaak63.gsub-stacktrace.txt");
				...
				protected void done(String logcat) {
					...
					Intent email = new Intent(Intent.ACTION_SENDTO,
						Uri.fromParts("mailto", "com.github.gaak63.gsub.android@gmail.com", null));
